// 参考自 https://observablehq.com/@d3/stacked-bar-chart/2?intent=fork
 ...
 *
 */
// 数据来源网页 https://observablehq.com/@d3/stacked-bar-chart/2?intent=fork 的文件附件
const dataURL =
...
d3.csv(dataURL, d3.autoType).then((data) => {
  ...
  svg.append("g")
    ...
    .join("rect") // 将元素绘制到页面上
      ...
      // 每个矩形的左上角纵轴定位 y 由它所绑定的数组的第二个元素 d[1]（堆叠的上边界）所决定
